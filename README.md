# MyTorrent - BitTorrent Client 

A fully functional BitTorrent client built using prompt engineering with React and Node.js, featuring real peer-to-peer networking, modern UI design, and complete protocol implementation. **DEPENDING ON WHAT COUNTRY YOU ARE ON, TORRENT DOWNLOAD MAY BE BLOCKED.**
